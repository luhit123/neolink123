...
const Login: React.FC = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // User will be created in Firestore by App.tsx with default Doctor role
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-cyan-900 to-slate-900 flex items-center justify-center p-4">
      <div className="bg-slate-800 rounded-2xl shadow-2xl p-8 w-full max-w-md border border-cyan-500/20">
        {/* Logo/Icon */}
        ...
        <div className="mt-6 text-center text-slate-400 text-sm">
          ...
          <p className="mt-2">Default role: <span className="text-cyan-400 font-semibold">Doctor</span></p>
        </div>
      </div>
    </div>
  );
