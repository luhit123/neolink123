  ...
  return (
    <>
      <PullToRefresh onRefresh={handleRefresh}>
        ...
        {/* Row 1: Unit Selection & NICU View */}
        ...
        {/* Row 2: Action Buttons - Grid on mobile, flex on desktop */}
        <div className="grid grid-cols-4 sm:flex sm:flex-wrap sm:items-center sm:justify-center gap-1.5 sm:gap-2">
          {hasRole(UserRole.Admin) && setShowAdminPanel && (
            <button onClick={() => setShowAdminPanel(true)} className="flex items-center justify-center sm:justify-start gap-1 sm:gap-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white p-2 sm:px-3 sm:py-2 rounded-lg sm:rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all font-bold text-xs sm:text-sm whitespace-nowrap shadow-md" title="Admin Dashboard">
          ...
          {(hasRole(UserRole.Admin) || hasRole(UserRole.Doctor)) && (
            <button onClick={() => setShowDeathsAnalysis(true)} className="flex items-center justify-center sm:justify-start gap-1 sm:gap-2 bg-gradient-to-r from-rose-500 to-red-600 text-white p-2 sm:px-3 sm:py-2 rounded-lg sm:rounded-xl hover:from-rose-600 hover:to-red-700 transition-all font-bold text-xs sm:text-sm whitespace-nowrap shadow-md" title="Deaths Analysis">
          ...
          {(hasRole(UserRole.Doctor) || hasRole(UserRole.Nurse)) && (
            <button onClick={() => setShowSmartHandoff(true)} className="flex items-center justify-center sm:justify-start gap-1 sm:gap-2 bg-gradient-to-r from-emerald-500 to-teal-600 text-white p-2 sm:px-3 sm:py-2 rounded-lg sm:rounded-xl hover:from-emerald-600 hover:to-teal-700 transition-all font-bold text-xs sm:text-sm whitespace-nowrap shadow-md" title="Smart Handoff">
          ...
          {hasRole(UserRole.Admin) && (
            <button onClick={() => setShowAIReportGenerator(true)} className="flex items-center justify-center sm:justify-start gap-1 sm:gap-2 bg-gradient-to-r from-violet-500 to-purple-600 text-white p-2 sm:px-3 sm:py-2 rounded-lg sm:rounded-xl hover:from-violet-600 hover:to-purple-700 transition-all font-bold text-xs sm:text-sm whitespace-nowrap shadow-md" title="AI Reports">
              <span className="text-sm sm:text-base">📊</span>
          ...
          {(hasRole(UserRole.Doctor) || hasRole(UserRole.Admin)) && (
            <button onClick={() => onShowReferrals ? onShowReferrals() : setShowReferralInbox(true)} className="relative flex items-center justify-center sm:justify-start gap-1 sm:gap-2 bg-gradient-to-r from-cyan-500 to-sky-600 text-white p-2 sm:px-3 sm:py-2 rounded-lg sm:rounded-xl hover:from-cyan-600 hover:to-sky-700 transition-all font-bold text-xs sm:text-sm whitespace-nowrap shadow-md" title="Referrals">
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
              </svg>
              <span className="hidden sm:inline">Referrals</span>
              {unreadReferrals > 0 && (
                <span className="absolute -top-1 -right-1 bg-red-500 text-white text-[10px] px-1.5 py-0.5 rounded-full font-bold shadow animate-pulse">
                  {unreadReferrals}
                </span>
              )}
            </button>
          ...
          <button
            ...
            className="flex items-center justify-center sm:justify-start gap-1 sm:gap-2 bg-gradient-to-r from-slate-600 to-slate-700 text-white p-2 sm:px-3 sm:py-2 rounded-lg sm:rounded-xl hover:from-slate-700 hover:to-slate-800 transition-all font-bold text-xs sm:text-sm whitespace-nowrap shadow-md"
            title="All Patients"
          >
            <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {(hasRole(UserRole.Doctor) || hasRole(UserRole.Nurse)) && (
            <button onClick={handleAddPatient} className="col-span-2 sm:col-span-1 flex items-center justify-center gap-1.5 sm:gap-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-3 py-2 sm:px-4 sm:py-2.5 rounded-lg sm:rounded-xl hover:from-green-600 hover:to-emerald-700 transition-all font-bold text-sm whitespace-nowrap shadow-lg" title="Add Patient">
          ...
          {userRole === UserRole.SuperAdmin && setShowSuperAdminPanel && (
            <button onClick={() => setShowSuperAdminPanel(true)} className="flex items-center justify-center sm:justify-start gap-1 sm:gap-2 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white p-2 sm:px-3 sm:py-2 rounded-lg sm:rounded-xl hover:from-indigo-600 hover:to-indigo-700 transition-all font-bold text-xs sm:text-sm whitespace-nowrap shadow-md" title="SuperAdmin">
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
